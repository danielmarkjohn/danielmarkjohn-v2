  ...
  return (
    <section id="experience" aria-labelledby="experience-title">
      ...
      <div className="relative">
        <div className="absolute left-5 top-0 bottom-0 w-0.5 bg-slate-200 dark:bg-slate-700" aria-hidden="true" />
        <ul className="space-y-8 ml-12">
          {experience.map((e, idx)=> (
            <li key={e.company} className="relative">
              ...
              <motion.article initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{once:true}} transition={{duration:0.5, delay: idx*0.1}} className="p-4 bg-white/60 dark:bg-slate-800/60 rounded shadow">
